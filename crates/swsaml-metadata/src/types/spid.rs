...
///
/// ```
/// use swsaml_metadata::types::spid::{SpidContactExtensions, SpidSpType};
///
...
impl SpidContactExtensions {
    ...
    fn parse_raw_xml(raw_xml: &str) -> Result<Option<Self>, SpidExtensionError> {
        ...
        let doc = swsaml_xml::uppsala::parse(&full_xml)
...
fn visit_elements<'a>(
    doc: &'a swsaml_xml::Document<'a>,
    node: swsaml_xml::NodeId,
