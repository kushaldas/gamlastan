...
use swsaml_core::namespace::{SAML_ASSERTION_NS, SAML_METADATA_NS, XMLDSIG_NS, XMLENC_NS};

use swsaml_xml::error::XmlError;
use swsaml_xml::helpers::format_datetime;
use swsaml_xml::serialize::SamlSerialize;

use crate::types::affiliation::AffiliationDescriptor;
use crate::types::attr_authority::AttributeAuthorityDescriptor;
use crate::types::authn_authority::AuthnAuthorityDescriptor;
use crate::types::contact::ContactPerson;
...
use crate::types::key_descriptor::{EncryptionMethod, KeyDescriptor};
use crate::types::localized::{LocalizedName, LocalizedUri};
use crate::types::organization::Organization;
use crate::types::pdp::PdpDescriptor;
use crate::types::role_descriptor::{RoleDescriptorBase, SsoDescriptorBase};
use crate::types::sp::{AttributeConsumingService, RequestedAttribute, SpSsoDescriptor};
