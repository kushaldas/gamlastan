...
use swsaml_core::namespace::{SAML_ASSERTION_NS, SAML_METADATA_NS, XMLDSIG_NS};

use swsaml_xml::deserialize::SamlDeserialize;
use swsaml_xml::error::XmlError;
use swsaml_xml::helpers::{
...
use crate::types::additional::AdditionalMetadataLocationRef;
use crate::types::affiliation::AffiliationDescriptorRef;
use crate::types::attr_authority::AttributeAuthorityDescriptorRef;
use crate::types::authn_authority::AuthnAuthorityDescriptorRef;
use crate::types::contact::{ContactPersonRef, ContactType};
use crate::types::endpoint::{EndpointRef, IndexedEndpointRef};
use crate::types::entity_descriptor::{
    EntitiesDescriptorRef, EntityDescriptorRef, EntityRolesRef, MetadataChildRef,
};
use crate::types::extensions::ExtensionsRef;
use crate::types::idp::IdpSsoDescriptorRef;
use crate::types::key_descriptor::{EncryptionMethodRef, KeyDescriptorRef, KeyUse};
use crate::types::localized::{LocalizedNameRef, LocalizedUriRef};
use crate::types::organization::OrganizationRef;
use crate::types::pdp::PdpDescriptorRef;
use crate::types::role_descriptor::{RoleDescriptorBaseRef, SsoDescriptorBaseRef};
use crate::types::sp::{AttributeConsumingServiceRef, RequestedAttributeRef, SpSsoDescriptorRef};
...
fn deserialize_requested_attribute_ref<'a>(
    ...
    for val_node in value_nodes {
        use swsaml_core::assertion::attribute::AttributeValueRef;
