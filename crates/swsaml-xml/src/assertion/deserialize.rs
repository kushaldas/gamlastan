...
use swsaml_core::assertion::attribute::{AttributeRef, AttributeStatementRef, AttributeValueRef};
use swsaml_core::assertion::authn::{AuthnContextRef, AuthnStatementRef, SubjectLocalityRef};
use swsaml_core::assertion::authz::{
    ActionRef, AuthzDecisionStatementRef, DecisionType, EvidenceRef,
};
use swsaml_core::assertion::conditions::{
    AudienceRestrictionRef, ConditionsRef, ProxyRestrictionRef,
};
use swsaml_core::assertion::issuer::IssuerRef;
use swsaml_core::assertion::name_id::{
    EncryptedIdRef, NameIdOrEncryptedIdRef, NameIdPolicyRef, NameIdRef,
};
use swsaml_core::assertion::subject::{
...
use swsaml_core::namespace::{SAML_ASSERTION_NS, XMLDSIG_NS, XSI_NS};
