...
use swsaml_metadata::types::endpoint::Endpoint;
use swsaml_metadata::types::role_descriptor::SsoDescriptorBase;

use crate::error::ProfileError;
use crate::session::SessionParticipant;
...
mod tests {
    ...
    fn test_find_slo_endpoint() {
        let base = swsaml_metadata::types::role_descriptor::SsoDescriptorBase {
