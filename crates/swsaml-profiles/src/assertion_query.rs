...
use swsaml_core::protocol::request::RequestedAuthnContext;
...
) -> Result<&'a [swsaml_core::assertion::types::Assertion], ProfileError> {
    // Verify InResponseTo
...
mod tests {
    ...
    fn test_process_query_response_success() {
        let response = Response {
            base: swsaml_core::protocol::response::ResponseBase {
                id: "_resp1".to_string(),
                version: SamlVersion::V2_0,
                issue_instant: Utc::now(),
                destination: None,
                ...
                status: swsaml_core::protocol::status::Status::success(),
            },
            assertions: vec![],
