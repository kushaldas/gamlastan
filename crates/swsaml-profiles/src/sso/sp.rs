...
use swsaml_core::assertion::name_id::{NameIdOrEncryptedId, NameIdPolicy};
...
use swsaml_security::replay::ReplayCache;
use swsaml_security::validation::{AssertionValidator, ValidationParams};

use crate::error::ProfileError;
use crate::sso::web_browser::{self, AuthnRequestOptions, AuthnResult};
...
fn extract_name_id(
    assertion: &swsaml_core::assertion::types::Assertion,
...
mod tests {
    ...
    use swsaml_core::protocol::response::ResponseBase;
    ...
    fn test_find_sso_endpoint_preferred() {
        let idp = IdpSsoDescriptor {
            sso_base: swsaml_metadata::types::role_descriptor::SsoDescriptorBase {
                base: swsaml_metadata::types::role_descriptor::RoleDescriptorBase::new(vec![
