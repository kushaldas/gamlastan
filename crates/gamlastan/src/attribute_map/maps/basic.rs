// Generated from pysaml2's curated `basic` attribute map by
// scripts/gen_attribute_maps.py — do not edit by hand.

/// Attribute NameFormat this map applies to.
pub const IDENTIFIER: &str = "urn:oasis:names:tc:SAML:2.0:attrname-format:basic";
...
pub static FRO: &[(&str, &str)] = &[
    ...
    (
        "urn:mace:dir:attribute-def:eduCourseMember",
        "eduCourseMember",
    ),
    (
        "urn:mace:dir:attribute-def:eduCourseOffering",
        "eduCourseOffering",
    ),
    (
    ...
    (
        "urn:mace:dir:attribute-def:eduPersonPrincipalNamePrior",
    ...
    ("urn:mace:dir:attribute-def:isMemberOf", "isMemberOf"),
