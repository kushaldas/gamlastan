...
mod tests {
    use super::*;
    use crate::assertion::authn::{AuthnContextRef, AuthnStatementRef};
    use crate::assertion::conditions::{AudienceRestrictionRef, ConditionsRef};
    use crate::assertion::issuer::IssuerRef;
