...
impl<'a> StatusCodeRef<'a> {
    ...
    pub fn is_success(&self) -> bool {
        self.value == crate::constants::STATUS_SUCCESS
    }
}
...
impl StatusCode {
    ...
    pub fn success() -> Self {
        StatusCode {
            value: crate::constants::STATUS_SUCCESS.to_string(),
            sub_status: None,
        }
    }
    ...
    pub fn requester() -> Self {
        StatusCode {
            value: crate::constants::STATUS_REQUESTER.to_string(),
            sub_status: None,
        }
    }
    ...
    pub fn responder() -> Self {
        StatusCode {
            value: crate::constants::STATUS_RESPONDER.to_string(),
            sub_status: None,
        }
    }
}
